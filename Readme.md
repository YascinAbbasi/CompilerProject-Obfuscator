Project Title: Mini C Obfuscator

Description: This project implements a code obfuscator for a simplified version of the C programming language called Mini C. The tool reads Mini C source code, parses it, and outputs a functionally equivalent but obfuscated version.
